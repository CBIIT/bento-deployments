...
class backendService:
  def createService(self, config):
    ...
    secrets={
            ...
            "NEO4J_PASSWORD":ecs.Secret.from_secrets_manager(secretsmanager.Secret.from_secret_name_v2(self, "db_pass_{}".format(service), secret_name='bento/bento/perf'), 'neo4j_password'),
            "NEO4J_USER":ecs.Secret.from_secrets_manager(secretsmanager.Secret.from_secret_name_v2(self, "db_user_{}".format(service), secret_name='bento/bento/perf'), 'neo4j_user'),
